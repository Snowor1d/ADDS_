...
class FightingModel(Model):
    ...
    def mesh_map(self):
        ...
        print("obstacle_mesh : ", self.obstacle_mesh)


        distance = {}
        path = {}
        
        print("mesh 개수 : ", len(self.mesh_list))
        ...
        for i, mesh1 in enumerate(self.mesh_list):
            ...
            for j, mesh2 in enumerate(self.mesh_list):
                if i == j:
                    ...
                    dist = math.sqrt(pow(mesh1_center[0]-mesh1_center[1], 2) + pow(mesh2_center[1]-mesh2_center[1],2))
                    distance[mesh1][mesh2] = dist
