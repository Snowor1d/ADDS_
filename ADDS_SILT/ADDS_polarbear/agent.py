    ...
    def select_Q(self, state) :
        ...
        if(robot_step_num%10==0):
            ...
            for i in pure_gray_space:
                ...
                s0 = a * self.model.dict_NoC[tuple_key] + b * self.model.dict_NoC[tuple_key]*each_space_agent_num.get(tuple_key) / area
                if s0 > s1:
                    s1 = s0
        ...
        if(mode=="GUIDE"):
            ...
            for j in range(len(action_list)):
                f3 = self.F3_direction_agents(state, action_list[j], "NOT_GUIDE", direction_agents_num)
