...
class FightingAgent(Agent):
    ...
    def __init__(self, unique_id, model, pos, type): 
        ...
        global robot_xy
        self.robot_step = 0
        self.current_action = ["LEFT", "GUIDE"]
        robot_xy = pos
        self.goal_init = 0
        self.type = type
    ...
    def robot_policy_Q(self):
        ...
        if(robot_step_num % 5 == 0):
            self.current_action = self.select_Q(robot_xy)
        next_action = self.current_action

        # print("next_action : ", next_action)
        #next_action = ["LEFT", "GUIDE"]
